...
LISTFLEX_USERNAME = os.getenv("LISTFLEX_USERNAME_DEBT")
LISTFLEX_PASSWORD = os.getenv("LISTFLEX_PASSWORD_DEBT")
...
SHEET_NAME = f"{next_month} 25 DEBT LF"
...
# Log into Listflex
driver.get("https://debt.listflex.com/lmadmin/login.php?r=plzlogin")
time.sleep(2)
...
driver.get("https://debt.listflex.com/lmadmin/client_integrations.php?client_id=575")
time.sleep(3)
